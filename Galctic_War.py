...
from helper import draw_text # Modul untuk menulis text (seperti start, quit, game over, dll)
import abc # Modul untuk implementasi abstrak methode
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self): # Fungsi untuk mengatur durasi palyer menerima bonus
        ...
        # Baris kode untuk mengerakkan player/pesawat
...
# Implementasi Polymorphisme dengan inheritance
